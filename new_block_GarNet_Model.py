...
norm_events, labels = open_npz_file()
...
np.savez('roc_new_block_GarNet', fpr=fpr, real_pred_prob=real_pred_prob, tpr=tpr, thresholds=thresholds, auc=auc, avg_frac_noise=avg_frac_noise, fprs=[fpr_75, fpr_90, fpr_98], thresh=[thresh_75, thresh_90, thresh_98])
